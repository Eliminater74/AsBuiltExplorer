...
namespace AsBuiltExplorer
{
  ...
  this.lblComp4VIN.Size = new Size(50, 16 );
  ...
  this.lblComp3VIN.Size = new Size(50, 16 );
  ...
  this.lblComp2VIN.Size = new Size(50, 16 );
  ...
  this.lblComp1VIN.Size = new Size(50, 16 );
  this.lblComp1VIN.TabIndex = 15;
  this.lblComp1VIN.Text = "[no file]";
  this.Button9.Location = new Point(538, 112 );
  ...
  this.Label23.Size = new Size(100, 16 );
  ...
  this.Label22.Size = new Size(100, 16 );
  ...
  this.btnCompLoad.Font = new Font("Microsoft Sans Serif", 9.75f, FontStyle.Bold, GraphicsUnit.Point, 0);
  ...
  this.ListView1.Font = new Font("Courier New", 9.75f, FontStyle.Regular, GraphicsUnit.Point, 0);
  ...
  this.TextBox5.Font = new Font("Microsoft Sans Serif", 9f, FontStyle.Regular, GraphicsUnit.Point, 0);
  ...
  this.tbxChecksumBin.Font = new Font("Courier New", 9.75f, FontStyle.Regular, GraphicsUnit.Point, 0);
  ...
  this.tbxConvertBin.Font = new Font("Courier New", 9.75f, FontStyle.Regular, GraphicsUnit.Point, 0);
  ...
  this.tbxConvertHex.Font = new Font("Courier New", 9.75f, FontStyle.Regular, GraphicsUnit.Point, 0);
  ...
  this.tbxData3bin2.Font = new Font("Courier New", 9.75f, FontStyle.Regular, GraphicsUnit.Point, 0);
  ...
  this.tbxData2bin2.Font = new Font("Courier New", 9.75f, FontStyle.Regular, GraphicsUnit.Point, 0);
  ...
  this.tbxData1bin2.Font = new Font("Courier New", 9.75f, FontStyle.Regular, GraphicsUnit.Point, 0);
  ...
  this.tbxData3bin1.Font = new Font("Courier New", 9.75f, FontStyle.Regular, GraphicsUnit.Point, 0);
  ...
  this.tbxData2bin1.Font = new Font("Courier New", 9.75f, FontStyle.Regular, GraphicsUnit.Point, 0);
  ...
  this.tbxData1bin1.Font = new Font("Courier New", 9.75f, FontStyle.Regular, GraphicsUnit.Point, 0);
  ...
  this.tbxChecksumHex.Font = new Font("Courier New", 9.75f, FontStyle.Regular, GraphicsUnit.Point, 0);
  ...
  this.tbxData3hex.Font = new Font("Courier New", 9.75f, FontStyle.Regular, GraphicsUnit.Point, 0);
  ...
  this.tbxData2hex.Font = new Font("Courier New", 9.75f, FontStyle.Regular, GraphicsUnit.Point, 0);
  ...
  this.Label3.Size = new Size(39, 16 );
  this.Label3.TabIndex = 4;
  this.Label3.Text = "Data:";
  this.tbxData1hex.Font = new Font("Courier New", 9.75f, FontStyle.Regular, GraphicsUnit.Point, 0);
  ...
  this.tbxModIDhex.Font = new Font("Courier New", 9.75f, FontStyle.Regular, GraphicsUnit.Point, 0);
  ...
  this.TextBox2.Font = new Font("Microsoft Sans Serif", 9f, FontStyle.Regular, GraphicsUnit.Point, 0);
  ...
  this.Label12.Location = new Point(214, 48 );
  this.Label12.Name = "Label12";
  this.Label12.Size = new Size(456, 16 );
  this.Label12.TabIndex = 2;
  this.Label12.Text = "When prompted, save the .AB file in the \"Deducer\" subfolder of this program.";
  this.Label9.AutoSize = true;
  this.Label9.Location = new Point(18, 48 );
  this.Label9.Name = "Label9";
  this.Label9.Size = new Size(138, 16 );
  ...
  this.btnDeduceSaveInfo.Location = new Point(208 , 17);
  this.btnDeduceSaveInfo.Name = "btnDeduceSaveInfo";
  this.btnDeduceSaveInfo.Size = new Size(96 , 26);
  ...
  this.Label14.Size = new Size(522, 16 );
  ...
  this.btnDeduceFigureIt.Font = new Font("Microsoft Sans Serif", 9.75f, FontStyle.Bold, GraphicsUnit.Point, 0);
  ...
  this.Label21.Location = new Point(20, 256 );
  this.Label21.Name = "Label21";
  this.Label21.Size = new Size(150, 16 );
  ...
  this.Label17.Size = new Size(522, 16 );
  ...
  this.TextBox3.Font = new Font("Microsoft Sans Serif", 9f, FontStyle.Regular, GraphicsUnit.Point, 0);
  ...
  this.Label18.Size = new Size(133, 16 );
  ...
  this.btnBrowseRefresh.Font = new Font("Microsoft Sans Serif", 9.75f, FontStyle.Bold, GraphicsUnit.Point, 0);
  this.btnBrowseRefresh.Location = new Point(6, 13);
  this.btnBrowseRefresh.Name = "btnBrowseRefresh";
  this.btnBrowseRefresh.Size = new Size(103, 32 );
  ...
  this.ContextMenuStrip2.Size = new Size(176 , 120);
  ...
  this.Label8.ForeColor = Color.FromArgb(0, 0, 192 );
  ...
  this.TextBox6.Font = new Font("Microsoft Sans Serif", 9f, FontStyle.Regular, GraphicsUnit.Point, 0);
