...
namespace AsBuiltExplorer
{
    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            // ApplyLocalization(); // Will be called in Load
      ...
      "AB, ABT, and UCDS formats"
        ...
        private void ApplyLocalization()
        {
            ...
            TabPage6.Text = Strings.Tab_Browse;
            TabPage9.Text = Strings.Tab_Decode;
            TabPage7.Text = Strings.Tab_Help;
            TabPage8.Text = Strings.Tab_About;

            // Tab: Compare
            chkCompareShowNames.Text = Strings.Chk_ShowModuleNames;
            chkShowOnlyMismatches.Text = Strings.Chk_ShowOnlyMismatches;
            chkCompareShowChecksum.Text = Strings.Chk_IncludeChecksum;

            Label6.Text = Strings.Lbl_File1;
            Label7.Text = Strings.Lbl_File2;
            Label22.Text = Strings.Lbl_File3;
            Label23.Text = Strings.Lbl_File4;

            btnCompBrowse1.Text = Strings.Btn_Browse;
            btnCompBrowse2.Text = Strings.Btn_Browse;
            Button7.Text = Strings.Btn_Browse;
            Button9.Text = Strings.Btn_Browse;
            btnCompLoad.Text = Strings.Btn_Load;
            btnViewDefs.Text = Strings.Btn_ViewCodeLibrary;

            // ListView Columns (Compare)
            if (ListView1.Columns.Count >= 11)
            {
                ListView1.Columns[0].Text = Strings.Col_ModuleAddress;
                ListView1.Columns[1].Text = Strings.Col_ModuleName;
                ListView1.Columns[2].Text = Strings.Col_Data1;
                ListView1.Columns[3].Text = Strings.Col_Data2;
                ListView1.Columns[4].Text = Strings.Col_Data3;
                ListView1.Columns[5].Text = Strings.Col_Same;
                ListView1.Columns[6].Text = Strings.Col_Binary;
                ListView1.Columns[7].Text = Strings.Col_KnownFeatures;
                ListView1.Columns[8].Text = Strings.Col_PartNumber;
                ListView1.Columns[9].Text = Strings.Col_Strategy;
